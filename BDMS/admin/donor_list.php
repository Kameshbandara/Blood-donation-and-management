      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <tr>
                  ...
                  <td><?php echo $row['donor_gender']; ?></td>
                    ...
                    <a style="padding: 5px;background: #dcdcdc;text-decoration: none;float: right;margin-top: 0px;margin-right: 12px;border-radius: 3px;font-size: 14px;font-weight: 400;color: #ff0000;transition: 0.5s;transition-property: background;" href='delete.php?id=<?php echo $row['donor_id']; ?>'>Delete </a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
