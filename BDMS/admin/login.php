...
<body background="admin_image\Login.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      ...
      <div class="card" style="height:300px;background-color:#404040;width:450px;margin-left:275px;border-radius: 15px;">
          <div class="card-body">

      <div class="row justify-content-lg-center justify-content-mb-center" >
      <div class="col-lg-6 mb-6 ">
      <div class="font-italic" style="font-weight:bold;color:white;margin-top:15px;">Username<span style="color:red">*</span></div>
    ...
    <div class="font-italic"style="font-weight:bold;color:white;">Password<span style="color:red">*</span></div>
    ...
    <div><input type="submit" name="login" class="btn btn-primary" value="LOGIN" style="cursor:pointer;width:180%;margin-left:95px;margin-top:10px;"></div>
    </div>
  </div>
    </div>
  </div></div>
