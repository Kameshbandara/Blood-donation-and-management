...
<?php include'ticker.php'; ?>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <h1 style="text-align:center;font-size:45px;margin-top:20px;margin-bottom:20px;">Welcome to BloodBank & Donor Management System</h1>
    <!-- The slideshow -->
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\Home1.jpeg" alt="Error" width="100%" height="600">
      </div>
      <div class="carousel-item">
        <img src="image\Home2.jpeg" alt="Error" width="100%" height="600">
      </div>
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" style="width:400px;height:250px;margin-top:40px;margin-left:60px;" src="image\Home4.jpeg" alt="Error" >
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#055099;color:white; margin-top:220px;margin-left:5px;margin-right:1600px;">Become a Donor </a>
            </div>
        </div>
